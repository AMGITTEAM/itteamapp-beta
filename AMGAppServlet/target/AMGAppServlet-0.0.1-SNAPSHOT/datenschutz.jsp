...
<body>
	<p>Verantwortlicher im Sinne der Datenschutzgesetze, insbesondere
	...
	<p>Unter den angegebenen Kontaktdaten unseres
		Datenschutzbeauftragten können Sie jederzeit folgende Rechte ausüben:</p>
	<ul>
		<li>Auskunft über Ihre bei uns gespeicherten Daten und deren
			Verarbeitung (Art. 15 DSGVO),</li>
		<li>Berichtigung unrichtiger personenbezogener Daten (Art. 16
			DSGVO),</li>
		...
		<li>Einschränkung der Datenverarbeitung, sofern wir Ihre Daten
			...
			DSGVO),</li>
		<li>Widerspruch gegen die Verarbeitung Ihrer Daten bei uns (Art.
			21 DSGVO) und</li>
	...
	<p></p>
	<h3>Erfassung allgemeiner Informationen beim Besuch unserer
		Website</h3>
	<h4>
	...
	<p>Wir verwenden Ihre Daten nicht, um Rückschlüsse auf Ihre Person
		zu ziehen. Informationen dieser Art werden von uns ggfs. statistisch
		ausgewertet, um unseren Internetauftritt und die dahinterstehende
		Technik zu optimieren.</p>
	<h4>
		<b>Rechtsgrundlage:</b>
	</h4>
	<p>Die Verarbeitung erfolgt gemäß Art. 6 Abs. 1 lit. f DSGVO auf
		Basis unseres berechtigten Interesses an der Verbesserung der
		Stabilität und Funktionalität unserer Website.</p>
	<h4>
		<b>Empfänger:</b>
	</h4>
	<p>Empfänger der Daten sind ggf. technische Dienstleister, die für
		den Betrieb und die Wartung unserer Webseite als Auftragsverarbeiter
		tätig werden.</p>
	<h4>
		<b>Speicherdauer:</b>
	</h4>
	<p>Die Daten werden gelöscht, sobald diese für den Zweck der
		Erhebung nicht mehr erforderlich sind. Dies ist für die Daten, die der
		Bereitstellung der Webseite dienen, grundsätzlich der Fall, wenn die
		jeweilige Sitzung beendet ist.</p>
	<h4>
		<b>Bereitstellung vorgeschrieben oder erforderlich:</b>
	</h4>
	<p>Die Bereitstellung der vorgenannten personenbezogenen Daten ist
		weder gesetzlich noch vertraglich vorgeschrieben. Ohne die IP-Adresse
		ist jedoch der Dienst und die Funktionsfähigkeit unserer Website nicht
	...
	<p>Hierdurch erhalten wir bestimmte Daten wie z. B. IP-Adresse,
		verwendeter Browser und Betriebssystem.</p>
	...
	<p>Natürlich können Sie unsere Website grundsätzlich auch ohne
	...
	<h4>
		<b>Speicherdauer und eingesetzte Cookies:</b>
	</h4>
	<p>Soweit Sie uns durch Ihre Browsereinstellungen oder Zustimmung
		die Verwendung von Cookies erlauben, können folgende Cookies auf
		unseren Webseiten zum Einsatz kommen:</p>
	<p>Der Browser wird auf dieser Website mit einer einmaligen ID
		versehen, welche bei jedem weiteren Besuch protokolliert wird, um die
		statistische Häufigkeit eines Besuches dieser Website zu erfassen.
		Dieser Cookie wird dauerhaft gespeichert.</p>
	<p>Soweit diese Cookies (auch) personenbezogene Daten betreffen
		können, informieren wir Sie darüber in den folgenden Abschnitten.</p>
	<p>Sie können über Ihre Browsereinstellungen einzelne Cookies oder
	...
	<ul>
		...
		<li>
			...
			<a href="https://support.google.com/accounts/answer/61416?hl=de"
				target="_blank" rel="nofollow noopener">https://support.google.com/accounts/answer/61416?hl=de</a>
		</li>
		<li>
			Opera:
			<a href="http://www.opera.com/de/help" target="_blank"
				rel="nofollow noopener">http://www.opera.com/de/help</a>
		</li>
		<li>
			Safari:
			<a
				href="https://support.apple.com/kb/PH17191?locale=de_DE&viewlocale=de_DE"
				target="_blank" rel="nofollow noopener">https://support.apple.com/kb/PH17191?locale=de_DE&viewlocale=de_DE</a>
		</li>
	</ul>
	<p></p>
	...
	<p>Bei der Registrierung für die Nutzung unserer personalisierten
		Leistungen werden einige personenbezogene Daten erhoben, und zwar Name
		und E-Mail-Adresse. Weiterhin kann in den Einstellungen freiwillig
		eine Klasse hinterlegt werden, um die Funktionen dieser Website zu
		erweitern. Sind Sie bei uns registriert, können Sie auf Inhalte und
		Leistungen zugreifen, die wir nur registrierten Nutzern anbieten.
		Selbstverständlich erteilen wir Ihnen jederzeit Auskunft über die von
		uns über Sie gespeicherten personenbezogenen Daten.</p>
	<h4>
		<b>Rechtsgrundlage:</b>
	</h4>
	<p>Die Verarbeitung der bei der Registrierung eingegebenen Daten
		erfolgt auf Grundlage einer Einwilligung des Nutzers (Art. 6 Abs. 1
		lit. a DSGVO).</p>
	<p>Dient die Registrierung der Erfüllung eines Vertrages, dessen
		...
		Verarbeitung der Daten Art. 6 Abs. 1 lit. b DSGVO.</p>
	<h4>
		<b>Empfänger:</b>
	</h4>
	<p>Empfänger der Daten sind ggf. technische Dienstleister, die für
		den Betrieb und die Wartung unserer Website als Auftragsverarbeiter
		tätig werden.</p>
	<h4>
		<b>Speicherdauer:</b>
	</h4>
	<p>Daten werden in diesem Zusammenhang nur verarbeitet, solange die
		...
		dieser Datenschutzerklärung angegebenen Kontaktdaten.</p>
	<h4>
		<b>Bereitstellung vorgeschrieben oder erforderlich:</b>
	</h4>
	<p>Die Bereitstellung Ihrer personenbezogenen Daten erfolgt
		...
		Zugang auf unsere angebotenen Inhalte und Leistungen gewähren.</p>
	<p></p>
