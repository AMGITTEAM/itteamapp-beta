SQLite Expert Professional version 3.3.0
-----------------------------------------

Release date: June 7, 2013

Copyright (C) 2006-2011 Bogdan Ureche
...
Features include:
 ...
 3. The Data Transfer Wizard allows import/export from/to SQL script, another SQLite database or an ADO data source.

 4. Display and edit data in the grid, including BLOB and image fields. Currently supports BMP, JPG and PNG image formats. 

 5. BLOB fields can be edited with the integrated hex editor.

 6. Execute SQL queries. Supports multiple SQL statements in the same query. 

 7. In-grid editing of live queries.

 8. Save/Load SQL scripts to/from file. 

 9. Transaction support. SQLite supports one level of transactions.

10. Data mapping. SQLite Expert supports custom data types, and 40 predefined data types. 
